        ...
        <div className="container mx-auto flex flex-wrap">
          ...
          <div className="w-full md:w-1/2 p-6">
            ...
            <p className="text-base md:text-lg mt-4">
              HealthHub is a user-friendly tool designed to bridge the gap in healthcare access across Nigeria. We understand the importance of finding reliable healthcare facilities quickly, which is why we’ve created a platform that allows users to easily search for hospitals within their region, export the information to a CSV file, and share it with others. Whether you're seeking medical care for yourself or helping a loved one, HealthHub provides up-to-date contact details and locations of hospitals near you.
            </p>
            <p className="text-base md:text-lg mt-4">
